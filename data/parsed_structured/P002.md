...
|--------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| Input: 𝑥 : ( B , L , D ) Output: 𝑦 : ( B , L , D ) 1: 𝑨 : ( D , N )← Parameter ⊲ Represents structured 𝑁 × 𝑁 | Input: 𝑥 : ( B , L , D ) 𝑦 : ( B , L , D ) 𝑨 : ( D , N )← Parameter ⊲ Represents structured 𝑁 × 𝑁 |
|                                                                                                              | Output:                                                                                           |
|                                                                                                              | 1:                                                                                                |
| matrix                                                                                                       | matrix                                                                                            |
...
| 𝑨 𝑛 Initialization   | 𝑨 𝑛 Initialization   | Field   |   Perplexity |
|----------------------|----------------------|---------|--------------|
...
- [23] [DeepSound. SampleRNN . https://github.com/deepsound-project/samplernn-pytorch . 2017.](https://github.com/deepsound-project/samplernn-pytorch)
...
The discretization step size is Thus the final discrete recurrence (2a) is as desired.
...
| Model    | Params   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   | Test Accuracy (%) at Seqence Length   |
|----------|----------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|
...
Note that the number of blocks for Mamba is doubled, because one Transformer 'layer' includes both the MHA and MLP blocks (and similarly for Hyena), which requires two Mamba blocks to match parameters (Section 3.4). "1
...
| Model    | Params   | Accuracy (%) at Seqence Length   | Accuracy (%) at Seqence Length   | Accuracy (%) at Seqence Length   | Accuracy (%) at Seqence Length   | Accuracy (%) at Seqence Length   | Accuracy (%) at Seqence Length   |
|----------|----------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|
