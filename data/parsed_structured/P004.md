...
Yuanzhi Li Phillip Wallis Lu Wang Yelong Shen ∗ Shean Wang
...
|--------------------|--------------------------|--------------------|-------------------|-------------------|
| GPT-3 (FT) GPT-3   | 175,255.8M               |               73.8 | 89.5 91.0         | 52.0/28.0/44.5    |
| (BitFit)           | 14.2M                    |               71.3 |                   | 51.3/27.4/43.5    |
...
| DeBERTa XXL LoRA | Batch Size # Epochs Learning Rate Weight Decay CLS Dropout LoRA Config. LoRA α | 8 5 1E-04 0 0.15 | 8 16 6E-05 0.01 0 | 32 30 2E-04 0.01 0 | 4 10 1E-04 0 0.1 r q = | 6 8 1E-04 0.01 0.1 v = 8 | 8 11 1E-04 0.01 0.2 | 4 11 2E-04 0.01 0.2 | 4 10 0.1 0.2 |
| DeBERTa XXL LoRA | Max Seq. Len.                                                                  | 256              |                   | 128                | r 8                    |                          |                     |                     | 2E-04        |
| DeBERTa XXL LoRA |                                                                                |                  | 128               |                    | 64                     | 512                      | 320                 | 320                 | 128          |
...
| Optimizer Weight Decay Dropout Prob Batch Size # Epoch Warmup Steps Learning Rate Schedule Label Smooth Learning Rate Adaptation LoRA α | 0.01 0.1 0.1 | AdamW 0.01 0.1 8 5 500 Linear 0.1 0.0002 r q = r v = 4 32 | 0.0 0.0 0.0 |
